...
#if !defined(CORE_FLASH_ALIGNED)
#define CORE_FLASH_ALIGNED   __attribute__((aligned(Flasher_::WORD_ALIGNMENT)))
#endif
...
public:
   ...
   enum {
      BASE_ADDRESS = FLASH_BASE_ADDRESS
   };
...
public:
   static const Data erased_word CORE_FLASH_ALIGNED;
};
