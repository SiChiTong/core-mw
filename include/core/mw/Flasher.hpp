...
#include <core/mw/impl/Flasher_.hpp>

NAMESPACE_CORE_MW_BEGIN

#if !defined(CORE_FLASH_ALIGNED) || defined(__DOXYGEN__)
#define CORE_FLASH_ALIGNED   __attribute__((aligned(Flasher::WORD_ALIGNMENT)))
#endif
...
public:
   ...
   enum {
      BASE_ADDRESS = Flasher_::BASE_ADDRESS
   };

   enum {
      PAGE_SIZE = Flasher_::PAGE_SIZE
   };

   enum {
      PROGRAM_ALIGNMENT = Flasher_::PROGRAM_ALIGNMENT
   };

   enum {
      WORD_ALIGNMENT = Flasher_::WORD_ALIGNMENT
   };
